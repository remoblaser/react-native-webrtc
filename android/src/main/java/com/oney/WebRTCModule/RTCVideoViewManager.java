...
public class RTCVideoViewManager extends SimpleViewManager<WebRTCView> {
  ...
  public @Nullable Map getExportedCustomDirectEventTypeConstants() {
    return MapBuilder.of("frameLayout", MapBuilder.of("registrationName", "onFrameLayout"));
  }

  /**
   * Sets the indicator which determines whether a specific {@link WebRTCView} is
   * to mirror the video specified by {@code streamURL} during its rendering. For
   * more details, refer to the documentation of the {@code mirror} property of
   * the JavaScript counterpart of {@code WebRTCView} i.e. {@code RTCView}.
   *
   ...
   *               specified by its associated {@code streamURL} during its
   *               rendering, {@code true}; otherwise, {@code false}.
   */
  ...
  /**
   * In the fashion of
   * https://www.w3.org/TR/html5/embedded-content-0.html#dom-video-videowidth and
   * https://www.w3.org/TR/html5/rendering.html#video-object-fit, resembles the
   * CSS style {@code object-fit}.
   *
   * @param view      The {@code WebRTCView} on which the specified
   *                  {@code objectFit} is to be set.
   ...
   * all {@code WebRTCView}s. For more details, refer to the documentation of the
   * {@code zOrder} property of the JavaScript counterpart of {@code WebRTCView}
   * i.e. {@code RTCView}.
   *
