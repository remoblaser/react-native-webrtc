...
abstract class CameraCapturer implements CameraVideoCapturer {
  ...
  public void setFlash(boolean enable) {
    if (currentSession != null) {
      currentSession.setFlash(enable);
    }
  }
  ...
  @Override
  public void initialize(@Nullable SurfaceTextureHelper surfaceTextureHelper, Context applicationContext,
  ...
  private void createSessionInternal(int delayMs) {
    ...
    cameraThreadHandler.postDelayed(new Runnable() {
      @Override
      public void run() {
        createCameraSession(createSessionCallback, cameraSessionEventsHandler, applicationContext, surfaceHelper,
  ...
  abstract protected void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback,
      CameraSession.Events events, Context applicationContext, SurfaceTextureHelper surfaceTextureHelper,
